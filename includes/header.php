    ...
    <header>
        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top bg-perso">
            <div class="container-fluid">
                <a class="nav-link <?php if ($title == "Accueil") echo 'active'; ?>" aria-current="page" href="<?php echo URL ?>"><i class="fas fa-home"></i> SWAP</a>
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <ul class="navbar-nav me-auto mb-2 mb-md-0">
                        <li class="nav-item">
                            <a class="nav-link <?php if ($title == "nous") echo 'active'; ?>" aria-current="page" href="<?php echo URL ?>">Qui sommes nous</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?php if ($title == "contact") echo 'active'; ?>" aria-current="page" href="<?php echo URL ?>">Contact</a>
                        </li>
                        <?php if (isAdmin()) : ?>
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="sousmenu" role='button' data-bs-toggle="dropdown"><i class="fas fa-user"></i><?php echo !isConnected() ? ' Espace Membre' : ' ' . $_SESSION['membre']['pseudo'] ?></a>
                            <ul class="dropdown-menu">
                                <?php if (!isConnected()) : ?>
